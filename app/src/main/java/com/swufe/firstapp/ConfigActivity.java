...
public class ConfigActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        float dollar2 = intent.getFloatExtra("dollar_value_key",0.0f);
        float euro2 = intent.getFloatExtra("euro_value_key",0.0f);
        float won2 = intent.getFloatExtra("won_value_key",0.0f);
